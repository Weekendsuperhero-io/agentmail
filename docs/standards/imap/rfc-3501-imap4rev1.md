...
The following documents contain definitions or specifications that are necessary to understand this document properly: The following documents describe quality-of-implementation issues that should be carefully considered when implementing this protocol:
...
- ALL (search key)
- ANSWERED (search key)
- [APPEND (command)](#6311-append-command)
- [AUTHENTICATE (command)](#622-authenticate-command)
- [BAD (response)](#713-bad-response)
...
- [BYE (response)](#715-bye-response)
- Body Structure (message attribute)
- [CAPABILITY (command)](#611-capability-command)
- CAPABILITY (response code)
- [CAPABILITY (response)](#721-capability-response)
- CC <string> (search key)
- [CHECK (command)](#641-check-command)
- [CLOSE (command)](#642-close-command)
- [COPY (command)](#647-copy-command)
- [CREATE (command)](#633-create-command)
- [DELETE (command)](#634-delete-command)
- DELETED (search key)
- DRAFT (search key)
- ENVELOPE (fetch item)
- ENVELOPE (fetch result)
- [EXAMINE (command)](#632-examine-command)
- [EXISTS (response)](#731-exists-response)
- [EXPUNGE (command)](#643-expunge-command)
- [EXPUNGE (response)](#741-expunge-response)
- Envelope Structure (message attribute)
- FAST (fetch item)
- [FETCH (command)](#645-fetch-command)
- [FETCH (response)](#742-fetch-response)
- FLAGGED (search key)
- FLAGS (fetch item)
- FLAGS (fetch result)
- [FLAGS (response)](#726-flags-response)
- FLAGS <flag list> (store command data item)
- FLAGS.SILENT <flag list> (store command data item)
...
- LARGER <n> (search key)
- [LIST (command)](#638-list-command)
- [LIST (response)](#722-list-response)
- [LOGIN (command)](#623-login-command)
- [LOGOUT (command)](#613-logout-command)
- [LSUB (command)](#639-lsub-command)
- [LSUB (response)](#723-lsub-response)
...
- NEW (search key)
- [NO (response)](#712-no-response)
- [NOOP (command)](#612-noop-command)
- NOT <search-key> (search key)
- [OK (response)](#711-ok-response)
- OLD (search key)
- ON <date> (search key)
...
- [PREAUTH (response)](#714-preauth-response)
- Permanent Flag (class of flag)
- READ-ONLY (response code)
- READ-WRITE (response code)
- [RECENT (response)](#732-recent-response)
- RECENT (search key)
- RECENT (status item)
- [RENAME (command)](#635-rename-command)
...
- [SEARCH (command)](#644-search-command)
- [SEARCH (response)](#725-search-response)
- SEEN (search key)
- [SELECT (command)](#631-select-command)
...
- [STARTTLS (command)](#621-starttls-command)
- [STATUS (command)](#6310-status-command)
- [STATUS (response)](#724-status-response)
- [STORE (command)](#646-store-command)
- SUBJECT <string> (search key)
- [SUBSCRIBE (command)](#636-subscribe-command)
...
- UNSEEN (search key)
- UNSEEN (status item)
- [UNSUBSCRIBE (command)](#637-unsubscribe-command)
- Unique Identifier (UID) (message attribute)
- [X<atom> (command)](#651-xatom-command)
